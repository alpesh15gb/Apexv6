                ...
                <form action="{{ route('admin.shifts.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div class="form-control">
                            ...
                            <input type="time" name="start_time" value="{{ old('start_time', '09:30') }}"
                        ...
                        <div class="form-control">
                            ...
                            <input type="time" name="end_time" value="{{ old('end_time', '18:30') }}"
                    ...
                    <div class="form-control mb-4">
                        ...
                        <input type="number" name="grace_period_minutes" value="{{ old('grace_period_minutes', 15) }}"
