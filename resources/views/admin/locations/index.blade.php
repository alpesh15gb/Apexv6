<x-app-layout>
    ...
    <x-slot name="actions">
        <a href="{{ route('admin.locations.create') }}" class="btn btn-primary btn-sm gap-2">
                ...
                <div class="card-body">
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <span class="badge badge-ghost badge-sm">{{ $location->code }}</span>
                        </div>
                    ...
                    <div class="flex items-center gap-4 mt-4 text-sm">
                        <div class="flex items-center gap-1">
                            ...
                            <span>{{ $location->users_count }} employees</span>
                        </div>
                        @if($location->geofence_radius)
                            <div class="flex items-center gap-1">
                                ...
                                <span>{{ $location->geofence_radius }}m radius</span>
                            </div>
                        @endif
                    </div>

                    <div class="card-actions justify-end mt-4">
                        <a href="{{ route('admin.locations.edit', $location) }}" class="btn btn-ghost btn-sm">Edit</a>
